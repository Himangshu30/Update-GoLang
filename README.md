...
=====
    ...
    git clone https://github.com/Himangshu30/Update-GoLang
    cd update-golang
...
Before running the script, make sure you have an untampered copy by verifying the SHA256 checksum.
    ...
    $ wget -qO hash.txt https://github.com/Himangshu30/Update-GoLang/blob/main/sha256-update.sh
...
Sample session:
    ...
    lab@ubu1:~$
    lab@ubu1:~$ git clone https://github.com/Himangshu30/Update-GoLang
